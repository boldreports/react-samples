                ...
                <div id="description">
                    ...
                    <ul>
                        <li>The font color is categorized using the <a
                            ...
                            target="_blank" rel="noreferrer">Conditional Formatting</a> feature in the <code>UnitInStock</code> column of table to differentiate the range of values.</li>
                        <li>The <code>TopN</code> filter is applied to the <a
                            ...
                            target="_blank" rel="noreferrer">table</a> and <a
                                ...
                                target="_blank" rel="noreferrer">chart</a> data regions to display the top five data from database. Similarly, the <code>BottomN</code> filter is applied to display the least demand products
                            from database.</li>
                    </ul>
                    <p>
